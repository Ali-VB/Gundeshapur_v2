...
const translations: Translations = {
  en: {
    ...
    toastSheetCreateFailed: 'Failed to create new sheet. Please try again.',
    toastSheetCreateError: 'An error occurred while creating the sheet.',
    toastSheetCreateNetworkError: 'A network error occurred. Please check your internet connection and try again.',
    // AI Librarian
  ...
  es: {
    ...
    toastSheetCreateFailed: 'No se pudo crear la nueva hoja. Por favor, inténtalo de nuevo.',
    toastSheetCreateError: 'Ocurrió un error al crear la hoja.',
    toastSheetCreateNetworkError: 'Ocurrió un error de red. Por favor, comprueba tu conexión a internet e inténtalo de nuevo.',
  ...
  fr: {
    ...
    toastSheetCreateFailed: 'Échec de la création de la nouvelle feuille. Veuillez réessayer.',
    toastSheetCreateError: 'Une erreur est survenue lors de la création de la feuille.',
    toastSheetCreateNetworkError: 'Une erreur réseau est survenue. Veuillez vérifier votre connexion internet et réessayer.',
